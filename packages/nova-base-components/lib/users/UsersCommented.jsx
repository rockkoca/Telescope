...
const UsersCommented = ({user}, {currentUser}) => {

  const twitterName = Users.getTwitterName(user);

  const terms = {view:"userCommented", userId: user._id};
...
UsersCommented.propTypes = {
  user: React.PropTypes.object.isRequired,
}

UsersCommented.contextTypes = {
  currentUser: React.PropTypes.object
}

UsersCommented.displayName = "UsersCommented";

module.exports = UsersCommented;